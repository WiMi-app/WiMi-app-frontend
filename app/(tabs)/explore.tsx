...
Challenge`}</Text>
        ...
        <ScrollView
          style={styles.exploreTopics}
          horizontal={true}
          showsVerticalScrollIndicator={false}
          showsHorizontalScrollIndicator={false}
          contentContainerStyle={styles.exploreTopicsScrollViewContent}
        >
          <LinearGradient locations={[0, 1]} colors={["#5858e8", "#9b5efc"]} style={{borderRadius: Border.br_21xl}}>
            <Pressable style={styles.pressable}>
              <Image
                style={[styles.flameVectorIcon, {width:11, height:12}]}
                source={require("../../assets/flame-vector.png")}
              />
              <Text style={[styles.iceBucketChallenge, styles.challengeTypo]}>
                Ice Bucket Challenge
              </Text>
            </Pressable>
          </LinearGradient>
          <Pressable style={[styles.golfChallengeTopic, styles.topicBorder]}>
            <Text style={[styles.golfChallenge, styles.challengeTypo]}>
              Golf Challenge
            </Text>
          </Pressable>
          <Pressable style={[styles.golfChallengeTopic, styles.topicBorder]}>
            <Text
              style={[styles.golfChallenge, styles.challengeTypo]}
            >{`Health & Wellness`}</Text>
          </Pressable>
          <Pressable style={[styles.financialTopic, styles.topicBorder]}>
            <Text style={[styles.golfChallenge, styles.challengeTypo]}>
              Financial
            </Text>
          </Pressable>
        </ScrollView>
        <View style={styles.exploreGallery}>
          <Image
            style={[styles.exploreGalleryChild, styles.exploreLayout]}
            // contentFit="cover"
            source={require("../../assets/rectangle-36.png")}
          />
          <Image
            style={[styles.exploreGalleryItem, styles.exploreLayout]}
            // contentFit="cover"
            source={require("../../assets/rectangle-37.png")}
          />
          <Image
            style={styles.exploreGalleryInner}
            // contentFit="cover"
          ...
          />
          <Image
            style={[styles.exploreGalleryChild1, styles.rectangleIconPosition]}
            // contentFit="cover"
            source={require("../../assets/rectangle-40.png")}
          />
          <Image
            style={[styles.exploreGalleryChild2, styles.exploreChildPosition1]}
            // contentFit="cover"
            source={require("../../assets/rectangle-41.png")}
          />
          <Image
            style={[styles.exploreGalleryChild3, styles.exploreChildPosition1]}
            // contentFit="cover"
            source={require("../../assets/rectangle-42.png")}
          />
          <Image
            style={[styles.exploreGalleryChild4, styles.exploreChildPosition1]}
            // contentFit="cover"
            source={require("../../assets/rectangle-43.png")}
          />
          <Image
            style={[styles.exploreGalleryChild5, styles.exploreChildPosition]}
            // contentFit="cover"
            source={require("../../assets/rectangle-44.png")}
          />
          <Image
            style={[styles.exploreGalleryChild6, styles.exploreChildPosition]}
            // contentFit="cover"
